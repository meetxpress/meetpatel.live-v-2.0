            ...
            statusHTML +='<div class="service-item content-box">';            
                if(status.fork == true){
                    statusHTML +='<div><a href="'+status.html_url+'" target="_blank" style="text-decoration:none">';
                        statusHTML +='<img src="https://img.icons8.com/ios-glyphs/25/4bffa5/code-fork.png" title="Forked" style="vertical-align:middle;"/>';
                    ...
                    statusHTML +='<div><a href="'+status.html_url+'" target="_blank" style="text-decoration:none">';
                        statusHTML +='<img src="https://img.icons8.com/ios-filled/22/4bffa5/repository.png" title="Repository" style="vertical-align:middle;"/>';
                        statusHTML +='<span class="text" style="font-size:20px; vertical-align:top; font-weight: bold; color: #4bffa5; padding-left:3px">'+ status.name +'</span>';
                    statusHTML +='</a></div>'; 
                }                
                statusHTML +='<div class="name">';
                    statusHTML +='<span style="margin-right: 15px;">';
                        statusHTML +='<img src="https://img.icons8.com/ios-filled/22/4bffa5/source-code.png" title="Language" style="vertical-align:middle;"/>';
                        if(status.language == null){                            
                            statusHTML +='<span class="text" style="font-size:18px; vertical-align:top; padding-left:3px">Not Found</span>';
                        } else{
                            statusHTML +='<span class="text" style="font-size:18px; vertical-align:top; padding-left:3px">'+status.language+'</span>';
                        }                
                    statusHTML +='</span>';
                    /*statusHTML +='<span class="con">';
...
//for direct count: https://api.github.com/repos/meetxpress/meetpatel.live-v-2.0/stats/contributors
